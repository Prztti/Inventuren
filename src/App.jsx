...
<section style={{minHeight:"100vh",display:"flex",alignItems:"center",background:`linear-gradient(160deg, #F0EEE9 0%, #EAE8E3 30%, #F2F0EB 60%, #F5F3EF 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1060,margin:"0 auto",padding:mob?"100px 20px 48px":"140px 40px 80px",position:"relative",width:"100%",zIndex:1}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:mob?"1fr":`1fr ${mob?"0":"340px"}`,gap:mob?0:40,alignItems:"center"}}>
      <div>
      ...
      {!mob && track==="tech" && (
        <R delay={0.2}>
          <div style={{display:"flex",justifyContent:"center",alignItems:"flex-start",marginTop:"-200px"}}>
            <img src="/images/ai-hero-visual.jpg" alt="Deep Analysis. Fast Execution. High Impact."
              style={{
                width:480,height:620,objectFit:"contain",

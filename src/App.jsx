...
en:{
  ...
  clusters:{
    tech:[
      {n:"Legal",d:"Corporate, IP & regulatory — Lansky & Partner RAe, Herbst Kinsky"},
  ...
  re:{
    ...
    fP1:"Serial CEO, trained as a lawyer, with over 25 years of real estate and hospitality experience. Transaction record exceeding EUR 600 million across residential, commercial and hotel portfolios.",
  ...
  tech:{
    ...
    stats:[{v:"€600m+",l:"Transaction volume advised"},{v:"€45m+",l:"VC & growth capital mobilised"},{v:"€12m+",l:"Research grants secured"},{v:"20+",l:"Years cross-sector expertise"},{v:"40+",l:"Projects in DACH & MENA"},{v:"6",l:"Industry verticals"}],
    fP1:"Trained as a lawyer, startup founder and serial CEO with over 25 years of operational experience. Transaction record exceeding EUR 600 million across six sectors — from telecom to real estate, hospitality, science and social impact.",
    ...
    secDetail:["Deutsche Telekom, A1 Group, Orange, Zain, Viettel, Huawei, Ericsson","Wiener Privatbank SE, EPI Immobilien Group, Uniqa Versicherung","European Stroke Organisation, SFU Wien, Donau Universitaet Krems","Lansky & Partner RAe, Herbst Kinsky","EPI Hospitality, Ibis Group, Arcotel Hotels","Integrationshaus Wien, ORF, Red Bull, Verein vidid"],
    ...
    serv:[
      ...
      {n:"04",t:"Agentic AI — Pioneer & Deploy",d:"Design and deploy autonomous multi-agent systems within your organisation or partnership network. From orchestration architecture to production: AI that acts independently, eliminates bottlenecks and creates compounding operational value.",tags:["Agentic AI","Multi-Agent","Autonomous"]},
      {n:"05",t:"Incubator & Company Building",d:"Building tech startups with founder experience: ideation, incorporation, fundraising, international scaling.",tags:["Building","Fundraising","Scaling"]},
      {n:"06",t:"Accelerator",d:"Fast-track programme for early-stage ventures: structured mentoring, network access, investor introductions and go-to-market support.",tags:["Accelerator","Mentoring","Go-to-Market"]},
    ],
...
de:{
  ...
  clusters:{
    tech:[
      {n:"Legal",d:"Gesellschafts-, IP- & Regulierungsrecht — Lansky & Partner RAe, Herbst Kinsky"},
  ...
  re:{
    ...
    fP1:"Jurist und Mehrfach-CEO mit über 25 Jahren Immobilien- und Hospitality-Erfahrung. Transaction Record von über EUR 600 Mio. in Wohn-, Gewerbe- und Hotel-Portfolios.",
  ...
  tech:{
    ...
    serv:[
      ...
      {n:"04",t:"Agentic AI — Pioneer & Deploy",d:"Konzeption und Deployment autonomer Multi-Agent-Systeme in Ihrem Unternehmen oder Partnernetzwerk. Von der Orchestrierungsarchitektur bis zur Produktion: AI, die eigenständig handelt, Engpässe beseitigt und nachhaltigen operativen Mehrwert schafft.",tags:["Agentic AI","Multi-Agent","Autonom"]},
      {n:"05",t:"Incubator & Company Building",d:"Tech-Startups aufbauen mit Founder-Erfahrung: Ideation, Gesellschaftsgründung, Fundraising, internationale Skalierung.",tags:["Building","Fundraising","Scaling"]},
      {n:"06",t:"Accelerator",d:"Fast-Track-Programm für Early-Stage-Ventures: strukturiertes Mentoring, Netzwerkzugang, Investorenvorstellungen und Go-to-Market-Support.",tags:["Accelerator","Mentoring","Go-to-Market"]},
    ],
...
<section style={{minHeight:"100vh",display:"flex",alignItems:"center",background:`linear-gradient(160deg, #F0EEE9 0%, #EAE8E3 30%, #F2F0EB 60%, #F5F3EF 100%)`,position:"relative",overflow:"hidden"}}>
  ...
  <div style={{maxWidth:1060,margin:"0 auto",padding:mob?"100px 20px 48px":"140px 40px 80px",position:"relative",width:"100%",zIndex:1}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:mob?"1fr":`1fr ${mob?"0":"340px"}`,gap:mob?0:40,alignItems:mid?"flex-start":"center"}}>
      <div>
      ...
      {!mob && (track==="tech" || track==="re") && (
        <R delay={0.2}>
          <div style={{display:"flex",justifyContent:"center",alignItems:"flex-start"}}>
            <img
              src={track==="tech"?"/images/ai-hero-visual.jpg":"/images/re-hero-visual.jpg"}
              alt="Deep Analysis. Fast Execution. High Impact."
              style={{
                width:mid?240:480,height:mid?240:620,objectFit:"contain",
                mixBlendMode:"lighten",
                filter:track==="tech"
                  ?"drop-shadow(0 0 40px rgba(200,149,42,0.28))"
                  :"drop-shadow(0 0 40px rgba(180,120,40,0.32))",

// Vercel Routing Middleware: password gate for the archived pre-audit version under /new.
// Only these paths are matched; the public site at / is never touched (/new2 redirects to /).
